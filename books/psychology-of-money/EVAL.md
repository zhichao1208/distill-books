...
cd 1k-books-skills
python3 tools/eval.py --book psychology-of-money --model claude-sonnet-4-6
# 预估成本 ≈ $0.53 / 10 场景
```

scenarios.json 10 个场景覆盖：big_purchase / fomo / enough / acute_stress / seeking_advice / windfall / housing / comparison / lifestyle_creep / time_horizon。
